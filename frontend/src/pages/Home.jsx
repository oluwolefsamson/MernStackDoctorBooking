            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                <p className="text__para">
                  Booking appointments is fast and easy, allowing you to quickly
                  and effortlessly schedule your visits. Access a network of
                  top-rated doctors and highly trusted professionals. Schedule
                  appointments anytime, anywhere, with 24/7 availability from
                  any device. Make informed choices with real patient feedback
                  through verified reviews. Rest assured, your health
                  information is protected with our secure and confidential
                  system.
                </p>
            ...
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                ...
                <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                  ...
                  unmatched, expert health care. From the laboratory to the
                  clinic.
                </p>
